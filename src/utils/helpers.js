...
export const normalizeFacebookLead = (lead = {}, options = {}) => {
  ...
  return {
    ...
    emailDiscoveryStatus: lead.email ? 'found' : (lead.emailDiscoveryStatus || 'not_run'),
    emailDiscoveryNotes: lead.emailDiscoveryNotes || '',
    emailDiscoveredAt: lead.emailDiscoveredAt || '',
