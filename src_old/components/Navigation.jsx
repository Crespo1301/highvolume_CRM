...
import { colors, buttonBase } from '../utils/theme';

export function Navigation() {
  const { view, setView, setSelectedIndex, leads, dncList, deadLeads, callLog, golfCourses, trash, emails, followUps, overdueCount } = useCRM();
